...
class GameTests(APITestCase):
    def setUp(self):
        ...
        # Assert that the response status code is 201 (CREATED) added response code to 
        # gamer registration in auth.py got back 200, because no code was identified
    ...
    def test_create_game(self):
        ...
        # game type created in gamer setup
        game = {
            "title": "Clue",
            "maker": "Milton Bradley",
            "skill_level": 5,
